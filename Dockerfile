...
#
# Most of the code came from https://github.com/William-Yeh/docker-ansible project. I added some.
#
...
LABEL maintainer=visavis2k@gmail.com
...
RUN echo "===> Enabling systemd..."  && \
    ...
    pip install --upgrade \
        pyyaml jinja2 pycrypto paramiko httplib2 setuptools && \
    pip install --ignore-installed ipaddress openshift      && \
    \
    \
